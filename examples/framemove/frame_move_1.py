...
class ArmCommanderMoveExample():
    """ This example demonstrates the following:
        - The creation of collision object (box) as a reference frame
        - The 'area_1' reference frame defines the origin and the orientation according to the box
        - The use of the parameter reference_frame in a move command to specify the reference frame of the move targets
    """
    def __init__(self):
        ...
        # create a collision object that acts as the reference frame
